...
{
    spi_dbg_print("> fmc516_lmk02000_init...\n");
...
{
    spi_dbg_print("> fmc516_lmk02000_write_reg...\n");
...
static void fmc516_lmk02000_load_regset(const struct default_dev_regs_t *regs)
{
    ...
    spi_dbg_print("> fmc516_lmk02000_load_regset...\n");
    while (regs[i].type != REGS_DEFAULT_END){
        spi_dbg_print("> fmc516_lmk02000_load_regset while: %d...\n", i);
