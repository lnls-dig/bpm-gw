...
#
# bpm_pcie_k7.tcl: Tcl script for re-creating project 'bpm_pcie_k7'
#
# Generated by Vivado on Mon Sep 28 17:24:52 CEST 2015
...
#
# 1. This project restoration tcl script (bpm_pcie_k7.tcl) that was generated.
#
...
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/ip_cores/pcie/7k325ffg900/ipcores_pkg.vhd"
...
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/top/pcie/top_k7.vhd"
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/ip_cores/pcie/7k325ffg900/ddr_core/mig_b.prj"
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/ip_cores/pcie/7k325ffg900/ddr_core/mig_a.prj"
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/ip_cores/pcie/7k325ffg900/ddr_core/ddr_core.xci"
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/ip_cores/pcie/7k325ffg900/axi_interconnect/axi_interconnect.xci"
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/ip_cores/pcie/7k325ffg900/axi_datamover_0/axi_datamover_0.xci"
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/ip_cores/pcie/7k325ffg900/pcie_core/pcie_core.xci"
#    "/home/adrian/praca/creotech/pcie_brazil/bpm-gw/hdl/syn/pcie/kc705.xdc"
...
# Create project
create_project bpm_pcie_k7 ./bpm_pcie_k7

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects bpm_pcie_k7]
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../ip_cores/pcie/7k325ffg900/ipcores_pkg.vhd"]"\
 ...
 "[file normalize "$origin_dir/../../top/pcie/top_k7.vhd"]"\
 "[file normalize "$origin_dir/../../ip_cores/pcie/7k325ffg900/ddr_core/mig_b.prj"]"\
 "[file normalize "$origin_dir/../../ip_cores/pcie/7k325ffg900/ddr_core/mig_a.prj"]"\
]
...
set file "$origin_dir/../../ip_cores/pcie/7k325ffg900/ipcores_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
...
set file "$origin_dir/../../top/pcie/top_k7.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../../ip_cores/pcie/7k325ffg900/ddr_core/ddr_core.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../ip_cores/pcie/7k325ffg900/ddr_core/ddr_core.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../../ip_cores/pcie/7k325ffg900/axi_interconnect/axi_interconnect.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../ip_cores/pcie/7k325ffg900/axi_interconnect/axi_interconnect.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
if { ![get_property "is_locked" $file_obj] } {
  set_property "synth_checkpoint_mode" "Singular" $file_obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../../ip_cores/pcie/7k325ffg900/axi_datamover_0/axi_datamover_0.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../ip_cores/pcie/7k325ffg900/axi_datamover_0/axi_datamover_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
if { ![get_property "is_locked" $file_obj] } {
  set_property "synth_checkpoint_mode" "Singular" $file_obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../../ip_cores/pcie/7k325ffg900/pcie_core/pcie_core.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../ip_cores/pcie/7k325ffg900/pcie_core/pcie_core.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
if { ![get_property "is_locked" $file_obj] } {
  set_property "synth_checkpoint_mode" "Singular" $file_obj
...
puts "INFO: Project created:bpm_pcie_k7"
