...
set_max_delay -datapath_only -from               [get_clocks fmc1_ref_clk] -to [get_clocks $gt_p2p_txoutclk_clocks]    $afc_fp2_clk1_period
set_max_delay -datapath_only -from               [get_clocks fmc2_ref_clk] -to [get_clocks $gt_p2p_txoutclk_clocks]    $afc_fp2_clk1_period

set_max_delay -datapath_only -from               [get_clocks $gt_p2p_txoutclk_clocks] -to [get_clocks fmc1_ref_clk]    $fmc1_ref_clk_period
set_max_delay -datapath_only -from               [get_clocks $gt_p2p_txoutclk_clocks] -to [get_clocks fmc2_ref_clk]    $fmc2_ref_clk_period
