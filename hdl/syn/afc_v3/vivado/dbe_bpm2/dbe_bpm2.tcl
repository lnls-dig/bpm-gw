...
#
# dbe_bpm2_2016.tcl: Tcl script for re-creating project 'dbe_bpm2'
#
...
#
# 1. This project restoration tcl script (dbe_bpm2_2016.tcl) that was generated.
#
...
# Create project
create_project -force dbe_bpm2 $origin_dir -part xc7a200tffg1156-2
...
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/dbe_bpm2.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/dbe_bpm2.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/dbe_bpm2.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/dbe_bpm2.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/dbe_bpm2.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/dbe_bpm2.cache/compile_simlib/vcs" $obj
...
set_property "ip_output_repo" "/home/lerwys/Repos/bpm-gw-upstream/bpm-gw/hdl/syn/afc_v3/vivado/dbe_bpm2/dbe_bpm2.cache/ip" $obj
