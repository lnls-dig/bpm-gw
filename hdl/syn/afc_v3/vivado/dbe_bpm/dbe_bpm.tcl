...
#
# Generated by Vivado on Wed Nov 16 10:33:49 BRST 2016
...
# Create project
create_project -force dbe_bpm $origin_dir -part xc7a200tffg1156-2
...
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/dbe_bpm.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/dbe_bpm.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/dbe_bpm.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/dbe_bpm.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/dbe_bpm.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/dbe_bpm.cache/compile_simlib/vcs" $obj
...
set_property "ip_output_repo" "/home/lerwys/Repos/bpm-gw-upstream/bpm-gw/hdl/syn/afc_v3/vivado/dbe_bpm/dbe_bpm.cache/ip" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../../../ip_cores/dsp-cores/hdl/modules/machine/uvx_130M/cos_lut_uvx_35_148/cos_lut_uvx_35_148.coe"]"\
 "[file normalize "$origin_dir/../../../../ip_cores/dsp-cores/hdl/modules/machine/uvx_130M/sin_lut_uvx_35_148/sin_lut_uvx_35_148.coe"]"\
...
set file "cos_lut_uvx_35_148/cos_lut_uvx_35_148.coe"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
set_property "library" "xil_defaultlib" $file_obj
...
set file "sin_lut_uvx_35_148/sin_lut_uvx_35_148.coe"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
set_property "library" "xil_defaultlib" $file_obj
...
set_property "modelsim.simulate.ieee_warnings" "1" $obj
...
set_property "modelsim.simulate.saif_scope" "" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7a200tffg1156-2 -flow {Vivado Synthesis 2016} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7a200tffg1156-2 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
