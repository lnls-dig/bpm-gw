...
#Signal
set_property PACKAGE_PIN AM9 [get_ports {trigger_o[0]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[0]}]

set_property PACKAGE_PIN AP11 [get_ports {trigger_o[1]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[1]}]

set_property PACKAGE_PIN AP10 [get_ports {trigger_o[2]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[2]}]

set_property PACKAGE_PIN AM11 [get_ports {trigger_o[3]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[3]}]

set_property PACKAGE_PIN AN8 [get_ports {trigger_o[4]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[4]}]

set_property PACKAGE_PIN AP8 [get_ports {trigger_o[5]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[5]}]

set_property PACKAGE_PIN AL8 [get_ports {trigger_o[6]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[6]}]

set_property PACKAGE_PIN AL9 [get_ports {trigger_o[7]}]
set_property IOSTANDARD LVCMOS15  [get_ports {trigger_o[7]}]
