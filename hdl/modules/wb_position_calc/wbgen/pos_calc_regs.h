/*
  ...
  * Created        : Tue Jul  7 10:31:54 2020
  * Standard       : ANSI C
...
#define POS_CALC_MONIT1_TAG_EN                WBGEN2_GEN_MASK(0, 1)

/* definitions for field: MONIT1 Synchronizing Trigger Delay in reg: MONIT1 Synchronizing Trigger */
#define POS_CALC_MONIT1_TAG_DLY_MASK          WBGEN2_GEN_MASK(1, 16)
#define POS_CALC_MONIT1_TAG_DLY_SHIFT         1
#define POS_CALC_MONIT1_TAG_DLY_W(value)      WBGEN2_GEN_WRITE(value, 1, 16)
#define POS_CALC_MONIT1_TAG_DLY_R(reg)        WBGEN2_GEN_READ(reg, 1, 16)

/* definitions for field: MONIT1 Desynchronization Counter Reset in reg: MONIT1 Synchronizing Trigger */
#define POS_CALC_MONIT1_TAG_DESYNC_CNT_RST    WBGEN2_GEN_MASK(17, 1)

/* definitions for field: MONIT1 Desynchronization Counter in reg: MONIT1 Synchronizing Trigger */
#define POS_CALC_MONIT1_TAG_DESYNC_CNT_MASK   WBGEN2_GEN_MASK(18, 14)
#define POS_CALC_MONIT1_TAG_DESYNC_CNT_SHIFT  18
#define POS_CALC_MONIT1_TAG_DESYNC_CNT_W(value) WBGEN2_GEN_WRITE(value, 18, 14)
#define POS_CALC_MONIT1_TAG_DESYNC_CNT_R(reg) WBGEN2_GEN_READ(reg, 18, 14)

/* definitions for register: MONIT1 Masking Control */

/* definitions for field: MONIT1 Masking Enable in reg: MONIT1 Masking Control */
#define POS_CALC_MONIT1_DATA_MASK_CTL_EN      WBGEN2_GEN_MASK(0, 1)
...
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_BEG_MASK WBGEN2_GEN_MASK(0, 16)
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_BEG_SHIFT 0
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_BEG_W(value) WBGEN2_GEN_WRITE(value, 0, 16)
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_BEG_R(reg) WBGEN2_GEN_READ(reg, 0, 16)

/* definitions for field: MONIT1 Beginning Data Masking Samples in reg: MONIT1 Data Masking Samples */
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_END_MASK WBGEN2_GEN_MASK(16, 16)
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_END_SHIFT 16
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_END_W(value) WBGEN2_GEN_WRITE(value, 16, 16)
#define POS_CALC_MONIT1_DATA_MASK_SAMPLES_END_R(reg) WBGEN2_GEN_READ(reg, 16, 16)
...
#define POS_CALC_MONIT_TAG_EN                 WBGEN2_GEN_MASK(0, 1)

/* definitions for field: MONIT Synchronizing Trigger Delay in reg: MONIT Synchronizing Trigger */
#define POS_CALC_MONIT_TAG_DLY_MASK           WBGEN2_GEN_MASK(1, 16)
#define POS_CALC_MONIT_TAG_DLY_SHIFT          1
#define POS_CALC_MONIT_TAG_DLY_W(value)       WBGEN2_GEN_WRITE(value, 1, 16)
#define POS_CALC_MONIT_TAG_DLY_R(reg)         WBGEN2_GEN_READ(reg, 1, 16)

/* definitions for field: MONIT Desynchronization Counter Reset in reg: MONIT Synchronizing Trigger */
#define POS_CALC_MONIT_TAG_DESYNC_CNT_RST     WBGEN2_GEN_MASK(17, 1)

/* definitions for field: MONIT Desynchronization Counter in reg: MONIT Synchronizing Trigger */
#define POS_CALC_MONIT_TAG_DESYNC_CNT_MASK    WBGEN2_GEN_MASK(18, 14)
#define POS_CALC_MONIT_TAG_DESYNC_CNT_SHIFT   18
#define POS_CALC_MONIT_TAG_DESYNC_CNT_W(value) WBGEN2_GEN_WRITE(value, 18, 14)
#define POS_CALC_MONIT_TAG_DESYNC_CNT_R(reg)  WBGEN2_GEN_READ(reg, 18, 14)

/* definitions for register: MONIT Masking Control */

/* definitions for field: MONIT Masking Enable in reg: MONIT Masking Control */
#define POS_CALC_MONIT_DATA_MASK_CTL_EN       WBGEN2_GEN_MASK(0, 1)
...
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_BEG_MASK WBGEN2_GEN_MASK(0, 16)
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_BEG_SHIFT 0
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_BEG_W(value) WBGEN2_GEN_WRITE(value, 0, 16)
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_BEG_R(reg) WBGEN2_GEN_READ(reg, 0, 16)

/* definitions for field: MONIT Beginning Data Masking Samples in reg: MONIT Data Masking Samples */
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_END_MASK WBGEN2_GEN_MASK(16, 16)
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_END_SHIFT 16
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_END_W(value) WBGEN2_GEN_WRITE(value, 16, 16)
#define POS_CALC_MONIT_DATA_MASK_SAMPLES_END_R(reg) WBGEN2_GEN_READ(reg, 16, 16)
...
/* [0xf4]: REG TbT Masking Control */
#define POS_CALC_REG_TBT_DATA_MASK_CTL 0x000000f4
/* [0xf8]: REG TbT Data Masking Samples */
